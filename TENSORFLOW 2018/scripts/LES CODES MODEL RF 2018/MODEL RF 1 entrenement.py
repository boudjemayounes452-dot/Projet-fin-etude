# -*- coding: utf-8 -*-
"""
Created on Thu May  7 15:45:28 2026
...
# -*- coding: utf-8 -*-
"""
Random Forest final - CICIDS2018 + Live + Botnet
...
LABELS_JSON_PATH = os.path.join(
    OUTPUT_DIR,
    "rf_final_labels.json"
)

METRICS_PATH = os.path.join(
    OUTPUT_DIR,
    "rf_final_metrics.txt"
)
...
# =========================================================
# 6) EVALUATION TEST EXTERNE BOTNET
# =========================================================
...
with open(METRICS_PATH, "w", encoding="utf-8") as f:
    f.write("===== RANDOM FOREST FINAL - 2018 CHRONO + LIVE + BOTNET =====\n\n")
...
plt.title("Random Forest - External Botnet Test")
plt.colorbar()
...
print("\nIMPORTANT :")
print("- Ce modèle RF est un modèle de comparaison offline.")
print("- Le test externe Botnet contient NORMAL + ATTACK.")
print("- Pour le déploiement ESP32, le modèle principal reste ANN/TFLite.")