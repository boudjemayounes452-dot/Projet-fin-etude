# -*- coding: utf-8 -*-
"""
CNN FINAL STABLE + TFLITE SANS OPTIMISATION - CICIDS2018 + LIVE + BOTNET
...
Objectif :
- Entraîner un modèle CNN binaire
- 0 = NORMAL / BENIGN
- 1 = ATTACK / BOTNET
- Utiliser le meilleur seed trouvé dans les 10 runs CNN : 42
- Stabiliser l'entraînement avec :
    * learning_rate plus faible
    * Dropout réduit
    * EarlyStopping plus patient
    * ReduceLROnPlateau
- Sauvegarder le modèle CNN final au format Keras
- Convertir le modèle CNN vers TFLite SANS optimisation pour ESP32
...
OUTPUT_DIR = os.path.join(
    BASE_DIR,
    "cnn_final_stable_2018_chrono_live_botnet_seed42_tflite_no_opt"
)
...
METRICS_PATH = os.path.join(
    OUTPUT_DIR,
    "cnn_final_stable_metrics_seed42.txt"
)

CONFUSION_MATRIX_PLOT_PATH = os.path.join(
    OUTPUT_DIR,
    "cnn_confusion_matrix_stable_seed42.png"
)

LOSS_CURVE_PLOT_PATH = os.path.join(
    OUTPUT_DIR,
    "cnn_loss_curve_stable_seed42.png"
)
...
# =========================================================
# 12) EVALUATION TEST EXTERNE BOTNET
# =========================================================
...
plt.title("CNN stable - External Botnet Test")
plt.colorbar()
...
# =========================================================
# 16) CONVERSION DU MODELE CNN VERS TFLITE SANS OPTIMISATION
# =========================================================
...
# car la version optimisée a donné PROB_ATTACK:nan sur ESP32.
...
# =========================================================
# 17) SAUVEGARDE METRIQUES
# =========================================================

with open(METRICS_PATH, "w", encoding="utf-8") as f:
    f.write("===== CNN FINAL STABLE + TFLITE SANS OPTIMISATION - 2018 CHRONO + LIVE + BOTNET =====\n\n")
...
print("- Le fichier .tflite est généré SANS optimisation pour éviter PROB_ATTACK:nan sur ESP32.")
print("- Sur ESP32, il faut appliquer la même normalisation : x_norm = (x - mean) / scale.")
print("- Les valeurs mean et scale sont dans cnn_normalization_stable_seed42.json.")