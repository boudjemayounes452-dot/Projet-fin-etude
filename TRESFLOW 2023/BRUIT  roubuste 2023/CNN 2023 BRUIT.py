# -*- coding: utf-8 -*-
"""
Created on Mon May 18 09:25:24 2026
...
# -*- coding: utf-8 -*-
"""
CNN FINAL + ROBUSTESSE BRUIT REPETE + ADVERSARIAL FGSM - CICIoT2023
...
- FGSM multi-classes est applique sur le CNN avec categorical_crossentropy.
"""
...
OUTPUT_DIR = r"C:\Users\DELL\Desktop\pfe 2023\result\cnn_2023_robustesse_bruit_adversarial_moyenne"
...
# Nombre de répétitions pour stabiliser le bruit
N_REPEATS_NOISE = 5

os.makedirs(OUTPUT_DIR, exist_ok=True)

KERAS_MODEL_PATH = os.path.join(OUTPUT_DIR, "cnn_final_4classes.keras")
BEST_MODEL_PATH = os.path.join(OUTPUT_DIR, "cnn_final_4classes_best.keras")
TFLITE_MODEL_PATH = os.path.join(OUTPUT_DIR, "cnn_final_4classes.tflite")
HEADER_FILE_PATH = os.path.join(OUTPUT_DIR, "cnn_model_data.h")

METRICS_PATH = os.path.join(OUTPUT_DIR, "cnn_final_metrics.txt")
LABELS_JSON_PATH = os.path.join(OUTPUT_DIR, "cnn_labels.json")
NORMALIZATION_JSON_PATH = os.path.join(OUTPUT_DIR, "cnn_normalization.json")

LOSS_PLOT_PATH = os.path.join(OUTPUT_DIR, "cnn_loss_curve.png")
ACCURACY_PLOT_PATH = os.path.join(OUTPUT_DIR, "cnn_accuracy_curve.png")
CONFUSION_MATRIX_PLOT_PATH = os.path.join(OUTPUT_DIR, "cnn_confusion_matrix.png")

ROBUSTNESS_CSV_PATH = os.path.join(
    OUTPUT_DIR,
    "cnn_robustesse_bruit_adversarial_ciciot2023.csv"
)

ROBUSTNESS_PLOT_PATH = os.path.join(
    OUTPUT_DIR,
    "cnn_robustesse_bruit_adversarial_ciciot2023.png"
)
...
# =========================================================
# 9) ENTRAINEMENT FINAL
# =========================================================

print("\n===== ENTRAINEMENT CNN 2023 =====")
...
# =========================================================
# 10) EVALUATION TEST SANS PERTURBATION
# =========================================================
...
# =========================================================
# 11) ANALYSE DE ROBUSTESSE : BRUIT REPETE + ADVERSARIAL FGSM
# =========================================================

print("\n===== ANALYSE DE ROBUSTESSE - CNN CICIoT2023 =====")
...
# =========================================================
# 11-A) BRUIT ALEATOIRE AVEC REPETITIONS
# =========================================================
...
# =========================================================
# 11-B) ADVERSARIAL FGSM MULTI-CLASSES
# =========================================================

print("\n===== GENERATION ADVERSARIAL FGSM - CNN CICIoT2023 =====")
...
# =========================================================
# 12) SAUVEGARDE RESULTATS ROBUSTESSE
# =========================================================

robustness_df = pd.DataFrame(robustness_results)

print("\n===== TABLEAU ROBUSTESSE CNN 2023 =====")
print(robustness_df)
...
plt.title("Robustesse bruit et adversarial - CNN 1D CICIoT2023")
...
plt.xlabel("Epoch")
plt.ylabel("Loss")
plt.title("CNN 4 Classes - Loss Curve")
plt.legend()
plt.grid(True)
plt.tight_layout()
...
plt.xlabel("Epoch")
plt.ylabel("Accuracy")
plt.title("CNN 4 Classes - Accuracy Curve")
plt.legend()
plt.grid(True)
plt.tight_layout()
...
plt.title("CNN 4 Classes - Confusion Matrix")
plt.colorbar()
...
with open(METRICS_PATH, "w", encoding="utf-8") as f:
    f.write("===== CNN FINAL + ROBUSTESSE BRUIT REPETE + ADVERSARIAL - CICIoT2023 =====\n\n")
    ...
    f.write("Flatten\n")
    f.write("Dense 8 ReLU\n")
    f.write("Dense 4 Softmax\n")
...
with open(HEADER_FILE_PATH, "w", encoding="utf-8") as f:
    ...
    f.write("\n};\n\n")
    f.write(f"const unsigned int cnn_model_tflite_len = {len(tflite_bytes)};\n\n")
    f.write("#endif\n")
...
print("\nIMPORTANT :")
print("- Ce script entraîne CNN 1D sur CICIoT2023 avec 4 classes.")
...
print("- Les données CNN gardent la forme (samples, 8, 1).")
