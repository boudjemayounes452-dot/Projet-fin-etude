# -*- coding: utf-8 -*-
"""
Created on Tue May 19 17:00:52 2026
...
# -*- coding: utf-8 -*-
"""
Random Forest final - 8 FEATURES
CICIDS2018 + Botnet 10 % SANS LIVE

Les fichiers contiennent 9 features, mais ce modèle utilise seulement 8 features.
...
OUTPUT_DIR = os.path.join(
    BASE_DIR,
    "rf_final_2018_8features_botnet10_sans_live"
)
...
MODEL_PATH = os.path.join(
    OUTPUT_DIR,
    "rf_final_2018_8features_botnet10_sans_live.joblib"
)

LABELS_JSON_PATH = os.path.join(
    OUTPUT_DIR,
    "rf_8features_labels.json"
)

METRICS_PATH = os.path.join(
    OUTPUT_DIR,
    "rf_8features_metrics.txt"
)

CONFUSION_MATRIX_PLOT_PATH = os.path.join(
    OUTPUT_DIR,
    "rf_8features_confusion_matrix.png"
)

FEATURE_IMPORTANCE_PLOT_PATH = os.path.join(
    OUTPUT_DIR,
    "rf_8features_feature_importance.png"
)
...
print("\n===== ENTRAINEMENT RANDOM FOREST FINAL 8 FEATURES =====")
...
with open(METRICS_PATH, "w", encoding="utf-8") as f:
    f.write("===== RANDOM FOREST FINAL - 2018 8 FEATURES + BOTNET 10 % SANS LIVE =====\n\n")
...
plt.title("Random Forest 8 features - External Botnet 90% Test")
plt.colorbar()
...
plt.title("Random Forest 8 features - Feature Importance")
plt.tight_layout()
...
print("- Version 8 features : Avg Fwd Segment Size n'est pas utilisée.")
