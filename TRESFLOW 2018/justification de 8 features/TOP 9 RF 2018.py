# -*- coding: utf-8 -*-
"""
Created on Tue May 19 16:45:48 2026
...
# -*- coding: utf-8 -*-
"""
Random Forest final - CICIDS2018 9 FEATURES + BOTNET 10 % SANS LIVE
...
Objectif :
- Entraîner un modèle Random Forest binaire
- 0 = NORMAL / BENIGN
- 1 = ATTACK / BOTNET
- Tester sur le test externe Botnet 90 %
- Générer métriques, matrice de confusion et importance des features
"""
...
OUTPUT_DIR = os.path.join(
    BASE_DIR,
    "rf_final_2018_9features_botnet10_sans_live"
)
...
MODEL_PATH = os.path.join(
    OUTPUT_DIR,
    "rf_final_2018_9features_botnet10_sans_live.joblib"
)

LABELS_JSON_PATH = os.path.join(
    OUTPUT_DIR,
    "rf_9features_labels.json"
)

METRICS_PATH = os.path.join(
    OUTPUT_DIR,
    "rf_9features_metrics.txt"
)

CONFUSION_MATRIX_PLOT_PATH = os.path.join(
    OUTPUT_DIR,
    "rf_9features_confusion_matrix.png"
)

FEATURE_IMPORTANCE_PLOT_PATH = os.path.join(
    OUTPUT_DIR,
    "rf_9features_feature_importance.png"
)
...
print("\n===== ENTRAINEMENT RANDOM FOREST FINAL 9 FEATURES =====")
...
with open(METRICS_PATH, "w", encoding="utf-8") as f:
    f.write("===== RANDOM FOREST FINAL - 2018 9 FEATURES + BOTNET 10 % SANS LIVE =====\n\n")
...
plt.title("Random Forest 9 features - External Botnet 90% Test")
plt.colorbar()
...
plt.title("Random Forest 9 features - Feature Importance")
plt.tight_layout()
...
print("- Version 9 features : ajout de Avg Fwd Segment Size.")
