# -*- coding: utf-8 -*-
"""
Created on Fri May  8 09:57:03 2026
...
# -*- coding: utf-8 -*-
"""
CNN 10 RUNS - CICIDS2018 + LIVE + BOTNET
...
- Sauvegarder résultats, résumé, labels, normalisation et meilleur modèle CNN
"""
...
OUTPUT_DIR = os.path.join(
    BASE_DIR,
    "cnn_10runs_2018_chrono_live_botnet"
)
...
RUNS_RESULTS_PATH = os.path.join(
    OUTPUT_DIR,
    "cnn_10runs_results.csv"
)

RUNS_SUMMARY_PATH = os.path.join(
    OUTPUT_DIR,
    "cnn_10runs_summary.txt"
)

NORMALIZATION_JSON_PATH = os.path.join(
    OUTPUT_DIR,
    "cnn_normalization.json"
)
...
# =========================================================
# 9) SAUVEGARDE RESULTATS DES 10 RUNS
# =========================================================
...
with open(RUNS_SUMMARY_PATH, "w", encoding="utf-8") as f:
    f.write("===== CNN 10 RUNS - 2018 CHRONO + LIVE + BOTNET =====\n\n")
    ...
    f.write("Matrice meilleur run [[TN FP], [FN TP]] :\n")
    f.write(np.array2string(best_cm))
    f.write("\n\n")

    f.write("===== CLASSIFICATION REPORT MEILLEUR RUN =====\n")
    f.write(best_report)
    f.write("\n")


# =========================================================
# 11) SAUVEGARDE DU MEILLEUR MODELE CNN
# =========================================================

best_model.save(BEST_MODEL_PATH)

with open(BEST_METRICS_PATH, "w", encoding="utf-8") as f:
    f.write("===== MEILLEUR MODELE CNN =====\n\n")
    f.write(f"Best seed : {best_seed}\n")
    f.write(f"Best F1 Attack : {best_f1_attack:.6f}\n\n")
...
print("Meilleur modèle CNN    :", BEST_MODEL_PATH)
...
print("\nIMPORTANT :")
print("- Ce modèle CNN utilise les mêmes fichiers que RF et ANN.")
