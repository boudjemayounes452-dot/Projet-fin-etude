...
void loop() {
  ...
  if (!parse8Floats(line, raw)) {
    ...
    Serial.println("PRED:PARSE_ERROR,CONF:0.0,TIME_US:0,VOLTAGE_V:0,CURRENT_MA:0,POWER_MW:0,ENERGY_J:0,ENERGY_MJ:0,HEAP_TOTAL:0,FREE_HEAP:0,USED_HEAP:0,TENSOR_ARENA:32768");
    Serial.println("----------------------------------");
    return;
  }
  ...
  if (!modelRunInference()) {
    ...
    Serial.println("PRED:INFERENCE_ERROR,CONF:0.0,TIME_US:0,VOLTAGE_V:0,CURRENT_MA:0,POWER_MW:0,ENERGY_J:0,ENERGY_MJ:0,HEAP_TOTAL:0,FREE_HEAP:0,USED_HEAP:0,TENSOR_ARENA:32768");
    Serial.println("----------------------------------");
    return;
  }
